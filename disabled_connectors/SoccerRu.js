...
export default class SoccerRu extends BaseConnector {
  ...
  static getFields(){
    return [
      ...
      {
        name: 'date',
        selector: '#block-system-main .node-created',
        type: 'text'
      },
      {
        name: 'content',
        selector: '#block-system-main .field-name-body',
        type: 'html'
      },
      {
        name: 'text',
